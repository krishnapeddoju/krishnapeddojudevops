...
var App = function () {
    ...
    var handleSidebarMenu = function () {
        ...
        if (strHash == "/Ports/DashBoard/") {
            dashboard.addClass('active');          
        	    ...
        	    if ($(".breadView a:first-child").attr('href') != '' && $(".breadView a:first-child").attr('href')!=undefined) {
        	        strHash = $(".breadView a:first-child").attr('href');
        	    }
    ...
    var handleFixedSidebar = function () {
        ...
        if (viewport.width >= 992) {
            ...
            if (menu.slimScroll !== null && menu.slimScroll!==undefined && menu.slimScroll !==''){
            menu.slimScroll({
                size: '7px',
                color: '#a1b2bd',
                opacity: .3,
