    ...
    public class PartnerController : PortKonnectBaseController
    {
        ...
        public ActionResult Partners()
        {
            ...
            try
            {
                ...
                {
                    if (GetPrivilegesFor(AppEntityIds.eGatePartner.ToString(), AppEntityCodes.eGatePartnerView.ToString()))//TODO: Need to maintain EntityFunction as ENum
        ...
        public ActionResult Partner()
        {
            if (CheckIsFirstTimeLogin())
            {
                if (GetPrivilegesFor(AppEntityIds.eGatePartner.ToString(), AppEntityCodes.eGatePartnerAdd.ToString()))//TODO: Need to maintain EntityFunction as ENum
